...
class Mycal_model extends CI_Model {
	...
	function generate ($year, $month) {
		...
		$conf['template'] = '
            ...
            {heading_title_cell}<th class="thheader" colspan="{colspan}">{heading}</th>{/heading_title_cell}
            ...
            {cal_cell_content}
                <div class="day_num bold-8">{day}</div>
            ...
            {cal_cell_no_content}<div class="day_num bold-8">{day}</div>{/cal_cell_no_content}
