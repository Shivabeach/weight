<body id="prime">
	...
	<main class="container">
		...
		<div class="container--main">
			<div class="card">
				<div class="card--inside">
					<div class="card--inside-header"><h5>Starches</h5></div>
					<div class="line"></div>
			...
			<div class="card">
				<div class="card--inside">
					<div class="card--inside-header"><h5>Notes</h5></div>
					<div class="line2"></div>
					<h5 class="headline fs-3 bold-6">Sugar</h5>
						<p class="pstate">
							Sugar is the inverse of the stock market. The market goes down, it takes forever to go back up. Sugar goes up, it takes forever to get it back down. I am sure Ketosis is the same.
						</p>
			...
			<div class="card">
				<div class="card--inside">
					<div class="card--inside-header"><h5>Weakness</h5></div>
		...
		<div class="container--right">
			<div class="card">
				<div class="card--inside">
					<div class="card--inside-header"><h5>Exercise</h5></div>
						...
						<?php	foreach($waled as $row):?>
							<?php
								...
								if($date == "08-2020"):
									echo "<p>I have walked " . $distance . " miles in August </p>";
								elseif($date == "09-2020"):
									echo "<p>I have walked " . $distance . " miles from August to September </p>";
								elseif($date == "10-2020"):
									echo "<p>I have walked " . $distance . " miles from August to October </p>";
								elseif ($date == "11-2020"):
									echo "<p>I have walked " . $distance . " miles from August to November </p>";
								elseif($date == "12-2020"):
									echo "<p>I have walked " . $distance . " miles from August to December </p>";
								elseif($date == "01-2021"):
